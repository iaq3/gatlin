...
class BaxterController():
    def __init__(self):
        ...
        self.move_robot_service = createService("%s_%s/move/arm" % (self.robot_name, self.limb_name), MoveRobot, self.handle_move_robot)
    ...
    def MoveToPoseWithIntermediate(self, limb, pose, inter1=True, inter2=True, inter3=False) :
        ...
        if inter2 :
            interpose2 = self.getOffsetPose(pose, offset)
            interpose2.position.z = max_z + offset
